...
- **Whole-system cutover:** [`docs/architecture/migration-plan.md`](docs/architecture/migration-plan.md) (D-014) — 18 waves, Mode A then Mode B. First capability slice still **D-004**.
